...
%hold on
plot(ADMM_bp_news20binary(1:7:s4,2),log10(abs(ADMM_bp_news20binary(1:7:s4,3)- f_ub)/f_ub),'--+','LineWidth',2);
hold on
...
%hold on
plot(ADMM_bp_news20binary(1:7:s4,2),log10(ADMM_bp_news20binary(1:7:s4,4)),'--+','LineWidth',2);
hold on
