...
%hold on
plot(ADMM_bp_news20scale2(1:20:s4,2),log10(abs(100*ADMM_bp_news20scale2(1:20:s4,3)- f_opt)/f_opt),'--+','LineWidth',2);
hold on
...
hold on
plot(ADMM_bp_news20scale2(1:20:s4,2),log10(ADMM_bp_news20scale2(1:20:s4,4)),'--+','LineWidth',2);
hold on
