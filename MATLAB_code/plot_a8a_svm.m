...
hold on
plot(ADMM_svm_a8am(1:30:s5,2),log10(abs(ADMM_svm_a8am(1:30:s5,3)- f_opt)/f_opt),'--+','LineWidth',2);
hold on
...
hold on
plot(KATYUSHA_svm_a8am(1:10:s4,2),log10((abs(KATYUSHA_svm_a8am(1:10:s4,3)- f_opt)/f_opt)),'--o','LineWidth',2);
...
saveas(gcf,'myplots/svm_a8a.eps','epsc');
