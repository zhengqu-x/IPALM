...
ADMM_svm_realsim= importdata('../IPALM/results/ADMM_SVM_realsim_beta_2',' ');
...
hold on
plot(ADMM_svm_realsim(1:10:s5,2),log10(abs(ADMM_svm_realsim(1:10:s5,3)- f_opt)/f_opt),'--+','LineWidth',2);
hold on
