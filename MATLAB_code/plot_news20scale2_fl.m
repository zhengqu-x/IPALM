...
ADMM_fl_news20scale2= importdata('../IPALM/results/ADMM_FL_news20scale2_beta_1',' ');
...
s5= size(ADMM_fl_news20scale2,1);
...
%hold on
plot(ADMM_fl_news20scale2(1:10:s5,2),log10(abs(ADMM_fl_news20scale2(1:10:s5,3)- f_opt)/f_opt),'--+','LineWidth',2);
hold on
