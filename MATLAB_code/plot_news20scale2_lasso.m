...
hold on
plot(ADMM_l1l_news20scale2(1:20:s4,2),log10(abs(ADMM_l1l_news20scale2(1:20:s4,3)- f_opt)/f_opt),'--+','LineWidth',2);
hold on
...
ylabel('log|F(x)- F^*|/F^*');
title('news20scale2');
legend('ASGARD-DL','IPALM-APPROX','LADMM','SMART-CD');
