...
%hold on
plot(ADMM_bp_rcv1mc(1:20:s4,2),log10(abs(ADMM_bp_rcv1mc(1:20:s4,3)- f_opt)/f_opt),'--+','LineWidth',2);
hold on
...
saveas(figure(1),'myplots/bp_rcv1mc_obj.eps','epsc');
figure(2);
...
%hold on
plot(ADMM_bp_rcv1mc(1:20:s4,2),log10(ADMM_bp_rcv1mc(1:20:s4,4)),'--+','LineWidth',2);
hold on
...
set(gcf,'Position',[10 10 350 400]);
saveas(figure(2),'myplots/bp_rcv1mc_infeas.eps','epsc');
