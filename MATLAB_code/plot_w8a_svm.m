...
hold on
plot(DLRCSGR_eps_svm_w8am(1:10:s2,2),log10((abs(DLRCSGR_eps_svm_w8am(1:10:s2,3)- f_opt)/f_opt)),'--s','LineWidth',2);
hold on
plot(ADMM_svm_w8am(1:30:s5,2),log10((abs(ADMM_svm_w8am(1:30:s5,3)-f_opt)/f_opt)),'--+','LineWidth',2);
hold on
...
%hold on
plot(KATYUSHA_svm_w8am(1:10:s4,2),log10((abs(KATYUSHA_svm_w8am(1:10:s4,3)- f_opt)/f_opt)),'--o','LineWidth',2);
